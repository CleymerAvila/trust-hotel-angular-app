...
export class SidebarOptions {
  ...
  options: MenuOption[] = [
    {label: 'Dashboard', route: '/dashboard', roles: ['ROLE_ADMIN','ROLE_MANAGER', 'ROLE_RECEPTIONIST'], icon: 'fa-solid fa-border-all'},
    ...
    {label: 'Servicios Habitacion', route: '/room-services', roles: ['ROLE_ADMIN','ROLE_MANAGER'], icon: 'fa-solid fa-concierge-bell'},
